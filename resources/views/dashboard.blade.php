    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="p-3 text-xs text-gray-500 font-bold text-center">Tên công việc</th> <!-- Thêm dòng này -->
    ...
    @foreach ($todos as $i => $t)
        <tr class="hover:bg-gray-50 transition">
            ...
            <td class="p-3 text-center space-x-2">
                ...
                <a href="{{ route('todos.edit', $t->id) }}" class="text-xs text-yellow-600 hover:underline">Sửa</a>
